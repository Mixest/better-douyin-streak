...
if not exist "data\state.json" (
    ...
    if not exist "state.json" (
        ...
        "%~dp0.venv\Scripts\python.exe" extract_cookie.py
...
if "%choice%"=="2" (
    ...
    "%~dp0.venv\Scripts\python.exe" run_cli.py --dry-run
    ...
    "%~dp0.venv\Scripts\python.exe" run_cli.py --sync-contacts
    ...
    "%~dp0.venv\Scripts\python.exe" run_cli.py
